...
class Fibonacii():
  ...
  def fibonacci_recursive(n, a=0, b=1):
    ...
    """
    if n >= a:
      return [a] + Fibonacii.fibonacci_recursive(n, b, a + b)
    else:
      return []
...
def main():
  ...
  try:
    print("\nThis program returns the fibonacci sequence"
          "to a number you enter using three differents \n"
          "algorithms one iterative, one recursive and one dynamic.\n"
    ...
    print("\n Recursive: {}".format(fibo.fibonacci_recursive(n)))
    print("\n Iterative: {}".format(fibo.fibonacci_iterative(n)))
    print("\n Dynamic Programming: {}".format(fibo.fibonacci_dyprogramming(n)))
    return 0
